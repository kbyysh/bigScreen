Cube("/image/V1.0.9/index.js", ["/node_modules/jquery/dist/jquery.js", "/node_modules/bcore/event.js", "/node_modules/lodash/lodash.js", "/node_modules/animejs/lib/anime.js"], function (module, exports, require, load, process, global) {
  ...
  module.exports = Event.extend(function Base(container) {
    ...
    render: function render(config, data) {
      ...
      if (this.data && this.data[0] && this.data[0].notAllow) {
    ...
    opacity: function opacity(args) {
      if (_.isPlainObject(args) && _.isNumber(args.value)) {
        this.container.find('img').css('opacity', args.value);
      }
    },
    scale: function scale(args) {
      if (_.isPlainObject(args) && _.isNumber(args.value)) {
        this.container.find('img').css('transform', "scale(".concat(args.value, ")"));
      }
    },
