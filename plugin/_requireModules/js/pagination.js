Cube("/_requireModules/js/pagination.js", [], function (module, exports, require, load, process, global) {
  ...
  module.exports = function () {
      ...
      if (this.options.jumper) {
        ...
        handle.forEach(function (v) {
          _this_1.input.addEventListener(v, function (e) {
            ...
            this.value = value_1;
            if (value_1 !== _this.options.pageIndex) _this.handleChangePage(value_1);
          });
        });
    ...
    Pagination.prototype.createElement = function (tag, classList) {
      ...
      if (classList) {
        if (_instanceof(classList, Array)) {
    ...
    Pagination.prototype.validate = function (options) {
      ...
      if (_typeof(options) !== 'object') throw new Error('options not an object');
      if (!options._this.container.find(options.element)) throw new Error('element of null');
    ...
    Pagination.prototype.setOptions = function (options) {
      this.element = options._this.container.find(options.element)[0];
