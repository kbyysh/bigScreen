Cube("/_requireModules/js/svg.min.js", [], function (module, exports, require, load, process, global) {
  ...
  !function (t, e) {
    ...
    function d(t) {
      return _instanceof(t, b.Matrix) || (t = new b.Matrix(t)), t;
    }
    function p(t, e) {
    ...
    function x(e) {
      for (var i = e.childNodes.length - 1; i >= 0; i--) _instanceof(e.childNodes[i], t.SVGElement) && x(e.childNodes[i]);
    ...
    b.did = 1e3, b.eid = function (t) {
      ...
      var i;
      return i = 'svg' == e.nodeName ? _instanceof(e.parentNode, t.SVGElement) ? new b.Nested() : new b.Doc() : 'linearGradient' == e.nodeName ? new b.Gradient('linear') : 'radialGradient' == e.nodeName ? new b.Gradient('radial') : b[a(e.nodeName)] ? new b[a(e.nodeName)]() : new b.Element(e), i.type = e.nodeName, i.node = e, e.instance = i, _instanceof(i, b.Doc) && i.namespace().defs(), i.setData(JSON.parse(e.getAttribute('svgjs:data')) || {}), i;
    }, b.prepare = function () {
    ...
    b.utils = {
      ...
      filterSVGElements: function filterSVGElements(e) {
        return this.filter(e, function (e) {
          return _instanceof(e, t.SVGElement);
        });
      } },
    b.defaults = {
      attrs: {
    ...
    b.Color = function (t) {
      var e;
      this.r = 0, this.g = 0, this.b = 0, t && ('string' == typeof t ? b.regex.isRgb.test(t) ? (e = b.regex.rgb.exec(t.replace(b.regex.whitespace, '')), this.r = parseInt(e[1]), this.g = parseInt(e[2]), this.b = parseInt(e[3])) : b.regex.isHex.test(t) && (e = b.regex.hex.exec(h(t)), this.r = parseInt(e[1], 16), this.g = parseInt(e[2], 16), this.b = parseInt(e[3], 16)) : 'object' == _typeof(t) && (this.r = t.r, this.g = t.g, this.b = t.b));
    }, b.extend(b.Color, {
    ...
    b.PathArray = function (t, e) {
      ...
      parse: function parse(t) {
        if (_instanceof(t, b.PathArray)) return t.valueOf();
        var e,
        n,
        r = {
          M: 2,
    ...
    b.Number = b.invent({
      create: function create(t, e) {
        this.value = 0, this.unit = e || '', 'number' == typeof t ? this.value = isNaN(t) ? 0 : isFinite(t) ? t : t < 0 ? -3.4e38 : 3.4e38 : 'string' == typeof t ? (e = t.match(b.regex.numberAndUnit)) && (this.value = parseFloat(e[1]), '%' == e[5] ? this.value /= 100 : 's' == e[5] && (this.value *= 1e3), this.unit = e[5]) : _instanceof(t, b.Number) && (this.value = t.valueOf(), this.unit = t.unit);
      },
      extend: {
        toString: function toString() {
    ...
    b.Element = b.invent({
      ...
      extend: {
        ...
        parent: function parent(e) {
          ...
          for (; i && _instanceof(i.node, t.SVGElement);) {
            if ('string' == typeof e ? i.matches(e) : _instanceof(i, e)) return i;
        ...
        doc: function doc() {
          return _instanceof(this, b.Doc) ? this : this.parent(b.Doc);
        },
        ...
        svg: function svg(t) {
          ...
          if (!(t && _instanceof(this, b.Parent))) return i.appendChild(t = e.createElement('svg')), this.writeDataToDom(), t.appendChild(this.node.cloneNode(!0)), i.innerHTML.replace(/^<svg>/, '').replace(/<\/svg>$/, '');
    ...
    b.FX = b.invent({
      ...
      extend: {
        animate: function animate(t, e, i) {
          'object' == _typeof(t) && (e = t.ease, i = t.delay, t = t.duration);
        ...
        target: function target(t) {
          return t && _instanceof(t, b.Element) ? (this._target = t, this) : this._target;
        },
        ...
        queue: function queue(t) {
          return ('function' == typeof t || _instanceof(t, b.Situation)) && this.situations.push(t), this.situation || (this.situation = this.situations.shift()), this;
        },
        dequeue: function dequeue() {
          return this.stop(), this.situation = this.situations.shift(), this.situation && (_instanceof(this.situation, b.Situation) ? this.start() : this.situation.call(this)), this;
        },
        initAnimations: function initAnimations() {
          ...
          for (t in n.animations) for (i = this.target()[t](), Array.isArray(i) || (i = [i]), Array.isArray(n.animations[t]) || (n.animations[t] = [n.animations[t]]), e = i.length; e--;) _instanceof(n.animations[t][e], b.Number) && (i[e] = new b.Number(i[e])), n.animations[t][e] = i[e].morph(n.animations[t][e]);
        ...
        eachAt: function eachAt() {
          ...
          if (s.transforms.length) {
            for (i = s.initialTransformation, t = 0, e = s.transforms.length; t < e; t++) {
              ...
              _instanceof(o, b.Matrix) ? i = o.relative ? i.multiply(new b.Matrix().morph(o).at(s.ease(this.pos))) : i.morph(o).at(s.ease(this.pos)) : (o.relative || o.undo(i.extract()), i = i.multiply(o.at(s.ease(this.pos))));
            }
            r.matrix(i);
          }
          return this;
    ...
    b.extend(b.FX, {
      attr: function attr(t, e, i) {
        if ('object' == _typeof(t)) for (var n in t) this.attr(n, t[n]);else this.add(t, e, 'attrs');
        return this;
      },
      ...
      x: function x(t, e) {
        if (_instanceof(this.target(), b.G)) return this.transform({
          x: t },
        e), this;
      ...
      size: function size(t, e) {
        if (_instanceof(this.target(), b.Text)) this.attr('font-size', t);else {
          var i;
      ...
      viewbox: function viewbox(t, e, i, n) {
        return _instanceof(this.target(), b.Container) && this.add('viewbox', new b.ViewBox(t, e, i, n)), this;
      },
      update: function update(t) {
        if (_instanceof(this.target(), b.Stop)) {
          if ('number' == typeof t || _instanceof(t, b.Number)) return this.update({
            offset: arguments[0],
            color: arguments[1],
            opacity: arguments[2] });
    ...
    b.Box = b.invent({
      create: function create(t, e, i, n) {
        if (!('object' != _typeof(t) || _instanceof(t, b.Element))) return b.Box.call(this, null != t.left ? t.left : t.x, null != t.top ? t.top : t.y, t.width, t.height);
    ...
    b.BBox = b.invent({
      create: function create(t) {
        if (b.Box.apply(this, [].slice.call(arguments)), _instanceof(t, b.Element)) {
          var i;
          try {
    ...
    b.RBox = b.invent({
      create: function create(t) {
        b.Box.apply(this, [].slice.call(arguments)), _instanceof(t, b.Element) && b.Box.call(this, t.node.getBoundingClientRect());
      },
      inherit: b.Box,
      parent: b.Element,
      extend: {
    ...
    b.RBox.prototype.constructor = b.RBox, b.Matrix = b.invent({
      create: function create(t) {
        var e,
        i = f([1, 0, 0, 1, 0, 0]);
        for (t = _instanceof(t, b.Element) ? t.matrixify() : 'string' == typeof t ? f(t.split(b.regex.delimiter).map(parseFloat)) : 6 == arguments.length ? f([].slice.call(arguments)) : Array.isArray(t) ? f(t) : 'object' == _typeof(t) ? t : i, e = k.length - 1; e >= 0; --e) this[k[e]] = null != t[k[e]] ? t[k[e]] : i[k[e]];
      },
      extend: {
    ...
    b.extend(b.Element, {
      attr: function attr(t, e, i) {
        ...
        if ('object' == _typeof(t)) for (e in t) this.attr(e, t[e]);else if (null === e) this.node.removeAttribute(t);else {
          ...
          'stroke-width' == t ? this.attr('stroke', parseFloat(e) > 0 ? this._stroke : null) : 'stroke' == t && (this._stroke = e), 'fill' != t && 'stroke' != t || (b.regex.isImage.test(e) && (e = this.doc().defs().image(e, 0, 0)), _instanceof(e, b.Image) && (e = this.doc().defs().pattern(0, 0, function () {
            this.add(e);
    ...
    b.extend(b.Element, {
      transform: function transform(t, e) {
        ...
        n,
        r = this;
        if ('object' != _typeof(t)) return i = new b.Matrix(r).extract(), 'string' == typeof t ? i[t] : i;
        if (i = new b.Matrix(r), e = !!e || !!t.relative, null != t.a) i = e ? i.multiply(new b.Matrix(t)) : new b.Matrix(t);else if (null != t.rotation) p(t, r), i = e ? i.rotate(t.rotation, t.cx, t.cy) : i.rotate(t.rotation - i.extract().rotation, t.cx, t.cy);else if (null != t.scale || null != t.scaleX || null != t.scaleY) {
    ...
    b.extend(b.FX, {
      transform: function transform(t, e) {
        ...
        n,
        r = this.target();
        return 'object' != _typeof(t) ? (i = new b.Matrix(r).extract(), 'string' == typeof t ? i[t] : i) : (e = !!e || !!t.relative, null != t.a ? i = new b.Matrix(t) : null != t.rotation ? (p(t, r), i = new b.Rotate(t.rotation, t.cx, t.cy)) : null != t.scale || null != t.scaleX || null != t.scaleY ? (p(t, r), t.scaleX = null != t.scale ? t.scale : null != t.scaleX ? t.scaleX : 1, t.scaleY = null != t.scale ? t.scale : null != t.scaleY ? t.scaleY : 1, i = new b.Scale(t.scaleX, t.scaleY, t.cx, t.cy)) : null != t.skewX || null != t.skewY ? (p(t, r), t.skewX = null != t.skewX ? t.skewX : 0, t.skewY = null != t.skewY ? t.skewY : 0, i = new b.Skew(t.skewX, t.skewY, t.cx, t.cy)) : t.flip ? ('x' == t.flip || 'y' == t.flip ? t.offset = null == t.offset ? r.bbox()['c' + t.flip] : t.offset : null == t.offset ? (n = r.bbox(), t.flip = n.cx, t.offset = n.cy) : t.flip = t.offset, i = new b.Matrix().flip(t.flip, t.offset)) : null == t.x && null == t.y || (i = new b.Translate(t.x, t.y)), i ? (i.relative = e, this.last().transforms.push(i), this._callStart()) : this);
      } }),
    b.extend(b.Element, {
    ...
    b.Transformation = b.invent({
      create: function create(t, e) {
        ...
        if (Array.isArray(t)) for (var i = 0, n = this.arguments.length; i < n; ++i) this[this.arguments[i]] = t[i];else if ('object' == _typeof(t)) for (var i = 0, n = this.arguments.length; i < n; ++i) this[this.arguments[i]] = t[this.arguments[i]];
    ...
    b.Parent = b.invent({
      ...
      extend: {
        ...
        each: function each(t, e) {
          ...
          n,
          r = this.children();
          for (i = 0, n = r.length; i < n; i++) _instanceof(r[i], b.Element) && t.apply(r[i], [i, r]), e && _instanceof(r[i], b.Container) && r[i].each(t, e);
          return this;
        },
    ...
    b.extend(b.Parent, {
      ungroup: function ungroup(t, e) {
        return 0 === e || _instanceof(this, b.Defs) || this.node == b.parser.draw ? this : (t = t || (_instanceof(this, b.Doc) ? this : this.parent(b.Parent)), e = e || 1 / 0, this.each(function () {
          return _instanceof(this, b.Defs) ? this : _instanceof(this, b.Parent) ? this.ungroup(t, e - 1) : this.toParent(t);
    ...
    b.ViewBox = b.invent({
      create: function create(t) {
        ...
        l = 1,
        c = /[+-]?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?/gi;
        if (_instanceof(t, b.Element)) {
          for (o = t, a = t, s = (t.attr('viewBox') || '').match(c), t.bbox, n = new b.Number(t.width()), r = new b.Number(t.height()); '%' == n.unit;) u *= n.value, n = new b.Number(_instanceof(o, b.Doc) ? o.parent().offsetWidth : o.parent().width()), o = o.parent();
          for (; '%' == r.unit;) l *= r.value, r = new b.Number(_instanceof(a, b.Doc) ? a.parent().offsetHeight : a.parent().height()), a = a.parent();
          ...
          return parseFloat(t);
        }) : Array.isArray(t) ? t : 'object' == _typeof(t) ? [t.x, t.y, t.width, t.height] : 4 == arguments.length ? [].slice.call(arguments) : h, this.x = t[0], this.y = t[1], this.width = t[2], this.height = t[3];
      },
      extend: {
        toString: function toString() {
    ...
    ['click', 'dblclick', 'mousedown', 'mouseup', 'mouseover', 'mouseout', 'mousemove', 'mouseenter', 'mouseleave', 'touchstart', 'touchmove', 'touchleave', 'touchend', 'touchcancel'].forEach(function (t) {
      ...
      var s = i.bind(n || t),
      o = _instanceof(t, b.Element) ? t.node : t;
      ...
      var r = _instanceof(t, b.Element) ? t.node : t;
      if (r.instance && ('function' != typeof i || (i = i._svgjsListenerId))) {
        ...
        (e || '').split(b.regex.delimiter).forEach(function (t) {
          ...
          a = t && t.split('.')[0],
          h = t && t.split('.')[1];
          if (i) s[a] && s[a][h || '*'] && (r.removeEventListener(a, s[a][h || '*'][i], n || !1), delete s[a][h || '*'][i]);else if (a && h) {
            if (s[a] && s[a][h]) {
              for (o in s[a][h]) b.off(r, [a, h].join('.'), o);
              delete s[a][h];
            }
          } else if (h) for (t in s) for (e in s[t]) h === e && b.off(r, [t, h].join('.'));else if (a) {
            if (s[a]) {
      ...
      fire: function fire(e, i) {
        return _instanceof(e, t.Event) ? this.node.dispatchEvent(e) : this.node.dispatchEvent(e = new b.CustomEvent(e, {
          detail: i,
          cancelable: !0 })),
        this._event = e, this;
      },
    ...
    b.extend(b.Element, {
      ...
      forward: function forward() {
        ...
        e = this.parent();
        return e.removeElement(this).add(this, t), _instanceof(e, b.Doc) && e.node.appendChild(e.defs().node), this;
      },
      ...
      front: function front() {
        var t = this.parent();
        return t.node.appendChild(this.node), _instanceof(t, b.Doc) && t.node.appendChild(t.defs().node), this;
      },
      back: function back() {
    ...
    b.extend(b.Element, {
      maskWith: function maskWith(t) {
        return this.masker = _instanceof(t, b.Mask) ? t : this.parent().mask().add(t), this.masker.targets.push(this), this.attr('mask', 'url("#' + this.masker.attr('id') + '")');
      },
    ...
    b.extend(b.Element, {
      clipWith: function clipWith(t) {
        return this.clipper = _instanceof(t, b.ClipPath) ? t : this.parent().clip().add(t), this.clipper.targets.push(this), this.attr('clip-path', 'url("#' + this.clipper.attr('id') + '")');
      },
    ...
    b.Stop = b.invent({
      ...
      extend: {
        update: function update(t) {
          return ('number' == typeof t || _instanceof(t, b.Number)) && (t = {
            offset: arguments[0],
            color: arguments[1],
            opacity: arguments[2] }),
    ...
    b.Bare = b.invent({
      create: function create(t, e) {
        if (this.constructor.call(this, b.create(t)), e) for (var i in e.prototype) 'function' == typeof e.prototype[i] && (this[i] = e.prototype[i]);
      },
      inherit: b.Element,
      extend: {
    ...
    b.extend(b.Line, b.Polyline, b.Polygon, b.Path, {
      marker: function marker(t, e, i, n) {
        var r = ['marker'];
        return 'all' != t && r.push(t), r = r.join('-'), t = _instanceof(arguments[1], b.Marker) ? arguments[1] : this.doc().marker(e, i, n), this.attr(r, t);
      } });
    ...
    ['fill', 'stroke'].forEach(function (t) {
      ...
      i[t] = function (i) {
        ...
        if ('string' == typeof i || b.Color.isRgb(i) || i && 'function' == typeof i.fill) this.attr(t, i);else for (e = M[t].length - 1; e >= 0; e--) null != i[M[t][e]] && this.attr(M.prefix(t, M[t][e]), i[M[t][e]]);
        return this;
      ...
      dx: function dx(t) {
        return this.x(new b.Number(t).plus(_instanceof(this, b.FX) ? 0 : this.x()), !0);
      },
      dy: function dy(t) {
        return this.y(new b.Number(t).plus(_instanceof(this, b.FX) ? 0 : this.y()), !0);
      },
    ...
    b.Set = b.invent({
      create: function create(t) {
        _instanceof(t, b.Set) ? this.members = t.members.slice() : Array.isArray(t) ? this.members = t : this.clear();
      },
      extend: {
        add: function add() {
          var t,
