Cube("/_requireModules/js/tarCloud.js", [], function (module, exports, require, load, process, global) {
  ...
  module.exports = function (win, doc) {
    ...
    TagCloud.prototype = {
      ...
      update: function update() {
        ...
        for (var j = 0, len = self.items.length; j < len; j++) {
          var fontsize = self.items[j].element.getAttribute('cc-fontSize') * 1;
          ...
          if (self.index == j) {
            ...
            self.items[j].fontsize = fontsize;
            ...
            self.items[j].fontsize = Math.ceil(per * 2) + fontsize - 6;
