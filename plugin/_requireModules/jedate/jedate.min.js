Cube("/_requireModules/jedate/jedate.min.js", ["/node_modules/jquery/dist/jquery.js"], function (module, exports, require, load, process, global) {

  function _instanceof(left, right) {if (right != null && typeof Symbol !== "undefined" && right[Symbol.hasInstance]) {return !!right[Symbol.hasInstance](left);} else {return left instanceof right;}}
  function _typeof(obj) {"@babel/helpers - typeof";return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) {return typeof obj;} : function (obj) {return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;}, _typeof(obj);}
  var $ = require('/node_modules/jquery/dist/jquery.js');
  !function (a, b) {
    'function' == typeof define && define.amd ? define(b) : 'object' == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = b() : a.jeDate = b();
  }(void 0, function () {
    ...
    function jeLunar(a, b, c) {
      function o(a) {
        var w,
        b = function b(a, _b) {
          var c = new Date(31556925974.7 * (a - 1900) + 6e4 * e[_b] + Date.UTC(1900, 0, 6, 2, 5));
          return c.getUTCDate();
        },
        c = function c(a) {
          var b,
    ...
    win = window,
    jet = {};
    return doc = document, regymdzz = 'YYYY|MM|DD|hh|mm|ss|zz', gr = /\-/g, regymd = 'YYYY|MM|DD|hh|mm|ss|zz'.replace('|zz', ''), parseInt = function parseInt(a) {
      return window.parseInt(a, 10);
    }, $Q = function $Q(a, b) {
      return b = b || document, a.nodeType ? a : b.querySelector(a);
    }, jeDate = function jeDate(a, b) {
      ...
      g = 1,
      h = arguments.length;
      for ('boolean' == typeof f && (e = f, f = arguments[1] || {}, g = 2), 'object' != _typeof(f) && 'function' != typeof f && (f = {}), h === g && (f = this, --g); h > g; g++) if (null != (a = arguments[g])) for (b in a) c = f[b], d = a[b], f !== d && void 0 !== d && (f[b] = d);
      return f;
      ...
      prevMonth: function prevMonth(a, b, c) {
        return jet.getYM(a, b, 0 - (c || 1));
      },
      nextMonth: function nextMonth(a, b, c) {
        return jet.getYM(a, b, c || 1);
      },
      setCss: function setCss(a, b) {
      ...
      isValDiv: function isValDiv(a) {
        return (/textarea|input/.test(a.tagName.toLocaleLowerCase()));
      },
      valText: function valText(a, b) {
        var c = $Q(a),
      ...
      getDateTime: function getDateTime(a) {
        var e,
        b = new DateTime(),
        c = jet.extend({
          YYYY: null,
    ...
    searandom = function searandom() {
      ...
      init: function init() {
        ...
        a.setDatas(), b.before && b.before(a.valCell), k && e && j && (f[1] ? (l = jet.getDateTime(f[0]), g = [{
          ...
          mm: jet.digit(l.mm),
          ss: jet.digit(l.ss) }]) :
        g = a.getValue(jet.isObj(f[0]) ? f[0] : {}), h || a.setValue([g[0]], b.format, !0)), n = [], a.minDate = '', a.maxDate = '', j && e || (n = a.m()), j && e ? e && jet.on(a.valCell, e, function () {
      ...
      m: function m() {
        ...
        j = (void 0 == that.$opts.zIndex ? 1e4 : that.$opts.zIndex, jet.isBool(that.$opts.isShow)),
        b = jet.reMatch(that.format),
        c = '' != that.getValue(),
        d = [],
        e = 7 == that.dlen ? 'hh:mm:ss' : 'YYYY-MM' + (that.dlen <= 2 ? '' : '-DD');
        return that.selectValue = [jet.parse(jet.getDateTime({}), e)], c && j ? (f = that.getValue().split(range), jet.each(new Array(range ? 2 : 1), function (a) {
          d[a] = {};
          jet.each(jet.reMatch(f[a]), function (c, e) {
            !!b[c] && (d[a][b[c]] = parseInt(e));
          });
          that.dlen >= 2 && !d[a]['MM'] && (d[a]['MM'] = 1);
          that.dlen >= 3 && !d[a]['DD'] && (d[a]['DD'] = 1);
        }), range && (that.selectValue = f)) : (g = that.getValue({})[0], i = jet.nextMonth(g.YYYY, g.MM || jet.getDateTime({}).MM), that.dlen > 2 && that.dlen <= 6 ? {
          YYYY: i.y,
          MM: i.m } :
        {}, d = [g]), that.selectDate = d, d;
      },
      ...
      getValue: function getValue(a) {
        ...
        return void 0 == a && jet.isBool(d.isShow) ? e = jet.valText(c) : (m = jet.isBool(d.isShow) ? '' == jet.valText(c) : !jet.isBool(d.isShow), n = jet.extend({
          ...
          MM: null,
          DD: null },
        a || {}), o = [], p = new Array(2), q = function q(a) {
      ...
      storeData: function storeData(a, b) {
      ...
      dateTemplate: function dateTemplate() {
        ...
        u = b.shortcut.length > 0 ? '{% for(var s=0;s<shortcut.length;s++){ %}<p @on=shortClick({%= shortcut[s].name %})>{%=shortcut[s].name%}</p>{% } %}' : '',
        v = function () {
          var b = '';
      ...
      compileBindNode: function compileBindNode(a) {
        var b = this,
        c = '@on',
        d = function d(a) {
          var b = /\(.*\)/.exec(a);
      ...
      methodEventBind: function methodEventBind() {
        ...
        jet.extend(that, {
          ...
          monthBtn: function monthBtn(a, b) {
            var f,
            g,
            j,
            k,
          ...
          shortClick: function shortClick(val) {
            ...
            if (that.format !== btnCfg[val].format) {
              ...
              that.closeDate();
              that.minDate = jet.isType(that.$opts.minDate, 'function') ? that.$opts.minDate(a) : that.$opts.minDate;
              that.maxDate = jet.isType(that.$opts.maxDate, 'function') ? that.$opts.maxDate(a) : that.$opts.maxDate;
              var data = that.m();
              that.storeData(data[0], data[1]);
              that.renderDate();
            }
          },
          yearClick: function yearClick(a) {
            var b, c, d, e, f, g;
          ...
          monthClick: function monthClick(a) {
            var b, c, d, e;
          ...
          daysClick: function daysClick(a) {
            var h, i, b, c, d, e, f, j;
          ...
          hmsClick: function hmsClick(a, b) {
            var j,
            k,
            l,
            m,
          ...
          sureBtn: function sureBtn() {
            ...
            if (range) {
              ...
              if (7 == that.dlen && f) return that.tips('cn' == opts.language.name ? '结束时间必须大于开始时间' : 'The end time must be greater than the start time'), void 0;
      ...
      eachYear: function eachYear(a, b) {
        var l,
        c = this,
        e = (c.$opts, parseInt(a)),
        f = [],
      ...
      eachMonth: function eachMonth(a) {
        var c = this,
        d = c.$opts,
        f = (d.range, []),
        g = c.selectDate,
      ...
      eachDays: function eachDays(a, b) {
        var F,
        G,
        H,
        I,
      ...
      eachTime: function eachTime(a, b) {
        var c = this,
        d = c.$opts,
        e = d.range,
        f = d.multiPane,
      ...
      parseValue: function parseValue(a, b) {
        var c = this,
        d = [],
        e = c.$opts,
        f = e.range;
      ...
      lunarOrien: function lunarOrien(a, b, c) {
        var d,
        e,
        f,
        g,
      ...
      dateOrien: function dateOrien(a, b, c) {
        var g,
        h,
        j,
        k,
