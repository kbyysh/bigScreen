Cube("/node_modules/animejs/lib/anime.min.js", [], function (module, exports, require, load, process, global) {
  ...
  !function (n, e) {
    ...
    var i = {
      ...
      svg: function svg(n) {
        return _instanceof(n, SVGElement);
      },
      inp: function inp(n) {
        return _instanceof(n, HTMLInputElement);
      },
      dom: function dom(n) {
    ...
    function b(n) {
      return i.arr(n) ? n : (i.str(n) && (n = g(n) || n), _instanceof(n, NodeList) || _instanceof(n, HTMLCollection) ? [].slice.call(n) : [n]);
    }
    function M(n, e) {
