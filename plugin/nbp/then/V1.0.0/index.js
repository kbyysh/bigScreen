Cube("/nbp/then/V1.0.0/index.js", ["/node_modules/bcore/event.js", "/node_modules/lodash/lodash.js"], function (module, exports, require, load, process, global) {
  ...
  module.exports = Event.extend(function Base(config) {
    ...
    init: function init(config) {
      ...
      (_this.config.handlers || []).forEach(function (item) {
        ...
        item._code = fnc;
        _this['then-'.concat(item.id)] = _this.createHandler(item);
      });
    },
    createHandler: function createHandler(obj) {
      var _this = this;
      return function (data) {
        _this.emit('then-'.concat(obj.id), obj._code(_.cloneDeep(data)));
      };
    },
    onExcute: function onExcute(data) {
      var _this = this;
      this.config.handlers.forEach(function (item) {
        _this['then-'.concat(item.id)](data);
      });
