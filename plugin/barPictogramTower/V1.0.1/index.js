Cube("/barPictogramTower/V1.0.1/index.js", ["/node_modules/jquery/dist/jquery.js", "/node_modules/bcore/event.js", "/node_modules/lodash/lodash.js", "/node_modules/echarts/index.js"], function (module, exports, require, load, process, global) {
  ...
  module.exports = Event.extend(function Base(container) {
    ...
    render: function render(config, data) {
      ...
      var _this = this;
      var symbol_1 = 'path://M0,10 L10,10 C5.5,10 5.5,5 5,0 C4.5,5 4.5,10 0,10 z',
      symbol_2 = 'path://M0,10 L10,10 L5,0 L0,10 z';
      this.destroy();
      ...
      legendDataResize.forEach(function (item, i) {
        ...
        var itemStyleObj = {
          normal: {
            shadowBlur: config.colorMatching.diy[i].outlineWidth ? config.colorMatching.diy[i].outlineWidth : 0,
            shadowColor: diyColor[i].outstartColor,
            shadowOffsetY: config.colorMatching.diy[i].outlineWidth !== 0 ? -1 : 0,
        ...
        var seriesBase = {
          ...
          type: 'pictorialBar',
          symbol: config.chartsSetting.XbarStyle && config.chartsSetting.XbarStyle === 'circle' ? symbol_1 : symbol_2,
          markPoint: {
            ...
            symbolOffset: config.markPoint ? [config.markPoint.offsetMd, config.markPoint.offsetTd * -1] : [0, 0],
            label: {
          ...
          label: {
            ...
            position: config.xAxisSetting && config.xAxisSetting.Xposition ? config.xAxisSetting.Xposition == 'top' ? 'bottom' : 'top' : 'top' },
      ...
      var markLinePosition = 0;
      markLinePosition = config.markLine && config.markLine.type.average.position == 'start' ? 40 : 0;
      var t = config.chartsSetting.grid.top,
      b = config.chartsSetting.grid.bottom,
      l = config.chartsSetting.grid.left + markLinePosition,
      ...
      gridDetail = ['bottomLeft', 'bottomRight', 'bottomCenter'].includes(posiLegend) ? _.assign(_.cloneDeep(gridDetail), {
        ...
        bottom: b + config.legend.textSetting.fontSize / 3 + config.legend.shapeSetting.tbPadding }) :
